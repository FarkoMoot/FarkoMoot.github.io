...
function Cardprojeto(props) {
  ...
  return /* @__PURE__ */ jsxs("section", { className: styles$2.card, children: [
    ...
    /* @__PURE__ */ jsx("button", { onClick: () => openModal(), children: /* @__PURE__ */ jsx("span", { children: "Ver Detalhes" }) }),
    /* @__PURE__ */ jsx(
      ReactModal,
      {
        isOpen,
...
const imgamese = "/assets/img_amese-1636414e.png";
const imgsamusci = "/assets/img_samusci-265bc637.png";
